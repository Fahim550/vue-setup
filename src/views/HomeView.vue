...
<main>
    <h4>Fahim</h4>
    <RouterLink to="/about" class="bg-green-500">about page</RouterLink>
    <p>{{ clickTimes }}</p>
    <button @click="increment" class="text-3xl font-bold underline">increment+</button>
    <button @click="decrement">decrement_</button>
</main>
<div>
...
const increment = () => {
    clickTimes.value = clickTimes.value + 1
    console.log(clickTimes.value);
